...
1. **GET FREE SPIN ON MICKY9 🎰** - Shows free spin promotional information with inline buttons:
...
- `TELEGRAM_CHANNEL` (Optional) - Telegram channel URL (default: `https://t.me/micky9`)
- `FREE_SPIN_URL` (Optional) - Free spin promotion URL (default: `https://micky9.com/RFMICKY9BOT9`)
- `FREE_CREDIT_URL` (Optional) - Free credit promotion URL (default: `https://micky9.com/RFMICKY9BOT9`)
...
```bash
docker build -t micky9-bot .
docker run -d --env-file .env micky9-bot
```
...
2. Create volume: `fly volumes create micky9_bot_data --size 1 --region sin`
...
**Micky9 Promo Bot** - Making marketing simpler! 🚀
